    ...
    "com.miHoYo.Yuanshen" | "com.miHoYo.ys.mi" | "com.miHoYo.ys.bilibili" | "com.miHoYo.GenshinImpact")
       ...
       if [[ "$action" = "powersave" ]]; then
         ...
         if [[ "$version" == "V130" ]]; then
           ...
           set_cpu_freq 300000 1804800 1075200 2419200 1075200 3200000
         fi
       fi
    ...
    "com.tencent.lolm"|"com.tencent.tmgp.sgame")
      ...
      if [[ "$action" = "powersave" ]]; then
        ...
        if [[ "$version" == "V130" ]]; then
          ...
          sched_limit 2000 0 1000 0 0 0
          sched_config "60 60" "78 83" "300" "400"
        fi
        realme_gt_on=0
      elif [[ "$action" = "balance" ]]; then
        ...
        if [[ "$version" == "V130" ]]; then
          ...
          sched_limit 2000 0 1000 0 0 0
          sched_config "62 55" "72 67" "200" "400"
        fi
        realme_gt_on=1
      elif [[ "$action" = "performance" ]]; then
        ...
        if [[ "$version" == "V130" ]]; then
          ...
          cpuctl background 1 0 0 1
          cpuctl top-app 1 0 0 max
          set_cpu_freq 1401600 1804800 1209600 2600000 844800 3200000
          sched_boost 1 0
          stune_top_app 0 0
          sched_limit 2000 0 1000 4000 1000 4000
          ...
          sched_boost 1 2
          stune_top_app 1 30
          sched_limit 8000 0 2000 0 0 0
          sched_config "62 60" "70 77" "300" "400"
        fi
      fi
    ;;
