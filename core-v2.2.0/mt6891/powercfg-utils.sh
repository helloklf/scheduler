...
adjustment_by_top_app() {
  case "$top_app" in
    ...
    "com.tencent.lolm"|"com.tencent.tmgp.sgame"|"com.garena.game.kgtw")
        ...
        if [[ "$action" = "powersave" ]]; then
          stune_top_app 0 0
          set_cpu_freq 925000 1800000 700000 1855000 659000 2127000
          cpuset '0-1' '0-1' '0-6' '0-7'
          gpu_dvfs_margin 15 2
        elif [[ "$action" = "balance" ]]; then
          stune_top_app 0 0
          sched_limit 5000 0 0 0 0 0
          set_cpu_freq 1525000 1800000 1162000 2200000 921000 2292000
          cpuset '0-1' '0-1' '0-6' '0-7'
          gpu_dvfs_margin 20 2
        elif [[ "$action" = "performance" ]]; then
          stune_top_app 0 0
          sched_limit 5000 0 500 0 500 0
          set_cpu_freq 1075000 2000000 1451000 2354000 1482000 2600000
          cpuset '0-1' '0-1' '0-6' '0-7'
          gbe_on=1
        elif [[ "$action" = "fast" ]]; then
          stune_top_app 0 10
          set_cpu_freq 1075000 2000000 1537000 2600000 1632000 2600000
          cpuset '0-1' '0-1' '0-6' '0-7'
          gbe_on=1
        elif [[ "$1" = "pedestal" ]]; then
          stune_top_app 0 100
