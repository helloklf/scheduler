...
adjustment_by_top_app() {
  case "$top_app" in
    ...
    "com.tencent.lolm"|"com.tencent.tmgp.sgame"|"com.garena.game.kgtw")
      ...
      if [[ "$action" = "powersave" ]]; then
        stune_top_app 0 0
        set_cpu_freq 925000 1800000 700000 1985000 659000 2354000
        cpuset '0-1' '0-1' '0-6' '0-7'
        gpu_dvfs_margin 15 2
      elif [[ "$action" = "balance" ]]; then
        stune_top_app 0 0
        sched_limit 4000 0 0 0 1000 0
        set_cpu_freq 1525000 1800000 1162000 1985000 921000 2463000
        cpuset '0-1' '0-1' '0-6' '0-7'
        realme_gt_on=1
        ...
        set_cpu_freq 1625000 2000000 1537000 2354000 1482000 2600000
        cpuset '0-1' '0-1' '0-6' '0-7'
        gbe_on=1
        realme_gt_on=1
        ...
        set_cpu_freq 1625000 2000000 1537000 2600000 1632000 2713000
        cpuset '0-1' '0-1' '0-6' '0-7'
        gbe_on=1
        realme_gt_on=1
